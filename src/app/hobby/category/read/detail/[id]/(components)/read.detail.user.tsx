...
import { Category, Essay, Status, UpdateStatusInput, Read } from '@/gql/types'
...
const ReadDetailUserButton = ({ read }: { read: Read }) => {
    ...
    <>
      ...
      >
        ...
        <Button
          ...
          gap={theme.space['1']}
          as={Link}
          href={`/hobby/category/read/edit/${read.id}`}
        >
          <Icon as={FaPencil} />
          <span>EDIT</span>
        </Button>
